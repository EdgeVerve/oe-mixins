...
/**
 * `OEScreenFlowMixin` is intended to help in the transition/flow from one screen to another. 
 * It supports both conditional as well as plain routing(transition/flow from one screen to another).
 *  
 * @polymer
 * @mixinFunction
 */
export const OEScreenFlowMixin = dedupingMixin(function (BaseClass) {
